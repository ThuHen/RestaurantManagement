...
namespace PresentationLayer
{
    public partial class UserView: SampleView
    {
        ...
        private void ProductView_Load(object sender, EventArgs e)
        {
            GetData();
            AddColumns();
            guna2DataGridView2.Columns["UserName"].Width = 500;
        ...
        public void GetData()
        {
            try
            {
                if (txtSearch.Text != "")
                {
                    guna2DataGridView2.DataSource = userBL.GetAccounts().Where(x => x.Username.ToLower().Contains(txtSearch.Text.ToLower())).ToList();
                }
                else
                {
                    guna2DataGridView2.DataSource = userBL.GetAccounts();
                }
        ...
        private void Edit(string id)
        {
            ...
            int idCategory = Convert.ToInt32(guna2DataGridView2.CurrentRow.Cells["RoleID"].Value);
